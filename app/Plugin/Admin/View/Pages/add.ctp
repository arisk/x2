...
<?php echo $this->Form->create('Page'); ?>
    <fieldset>
        <legend><?php echo __('Create new Content'); ?></legend>
        <?php
        ...
        <div class="input link">
            <?php if($richtext): ?>
            <?php echo $this->Html->link(__('Disable rich text'), array('action'=>'add'), array('class'=>'btn btn-info')); ?>
            <?php else: ?>
            <?php echo $this->Html->link(__('Enable rich text'), array('action'=>'add', true), array('class'=>'btn btn-info')); ?>
            <?php endif; ?>
        </div>
        <?php
